...
IO.readLines @"/Users/alex/Repository/Evolution/Tests/test1" 
|> Seq.toList
|> List.map IO.split
|> List.iter (DNA.events)

IO.writeLines @"/Users/alex/Repository/Evolution/Results/test_v2.fa" DNA.DNAList
